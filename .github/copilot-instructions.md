...
`mcts-research-explorer` — Monte Carlo Tree Search engine for adaptive research traversal — callback-based, UCB1 selection, plug-in search/expand/score functions.
